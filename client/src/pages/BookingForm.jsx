                              ...
                              <div class="card-header">
                                  <div class="row g-2">
                                      ...
                                      <div class="form-group col-md-4">
                                          ...
                                          <input type="date" class="form-control" name='fecha_reservacion' onChange={handleChange} value={values.fecha_reservacion} />
                                      </div>
                                      <div class="form-group col-md-4">
                                          <label class='form-label'>Fecha de entrada</label>
                                          <input type="date" class="form-control" name='fecha_entrada' onChange={handleChange} value={values.fecha_entrada} />
                                      </div>
                                      <div class="form-group col-md-4">
                                          <label class='form-label'>Fecha de salida</label>
                                          <input type="date" class="form-control" name='fecha_salida' onChange={handleChange} value={values.fecha_salida} />
                                      </div>
